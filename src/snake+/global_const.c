...
// Options Menus
void (*const snake_draw_options_menu_functions[SNAKE_COUNT_OPTIONS_MENUS])() = {
    snake_draw_options_menu_1280_720,
    snake_draw_options_menu_1920_1080,
    snake_draw_options_menu_2560_1440
};
